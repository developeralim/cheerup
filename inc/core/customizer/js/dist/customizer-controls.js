    ...
    (function($, api, _) {
        ...
        var Bunyad_CZ_Context = function() {
            var self = {
                ...
                setActiveState: function(control) {
                    control.active.set(self.shouldDisplay(control));
        ...
        var Bunyad_CZ_Fonts = function() {
            var self = {
                ...
                getOptions: function() {
                    return this.get("google").concat(this.get("system"));
                }
            };
            return self;
        }();
        api.controlConstructor["bunyad-font-family"] = api.Control.extend({
            ready: function() {
                ...
                select.selectize({
                    ...
                    options: Bunyad_CZ_Fonts.getOptions(),
                    optgroups: [ {
                        value: "google",
                        label: "Google Fonts"
                    }, {
                ...
                if (select.data("selected")) {
                    select[0].selectize.setValue(select.data("selected"));
                }
